...
export const CHAMPIONS = [
  'Aatrox','Ahri','Akali','Akshan','Alistar','Ambessa','Amumu','Annie','Ashe','Aurelion Sol','Aurora','Bard','Blitzcrank','Brand','Braum','Caitlyn','Camille','Cho\'Gath','Corki','Darius','Diana','Dr. Mundo','Draven','Ekko','Evelynn','Ezreal','Fiddlesticks','Fiora','Fizz','Galio','Garen','Gnar','Gragas','Graves','Gwen','Hecarim','Heimerdinger','Irelia','Janna','Jarvan IV','Jax','Jayce','Jhin','Jinx','K\'Sante','Kai\'Sa','Kalista','Karma','Kassadin','Katarina','Kayle','Kayn','Kennen','Kha\'Zix','Kindred','Kog\'Maw','Lee Sin','Leona','Lillia','Lissandra','Lucian','Lulu','Lux','Malphite','Maokai','Master Yi','Mel','Milio','Miss Fortune','Mordekaiser','Morgana','Nami','Nasus','Nautilus','Nidalee','Nilah','Nocturne','Norra','Nunu & Willump','Olaf','Orianna','Ornn','Pantheon','Poppy','Pyke','Rakan','Rammus','Rell','Renekton','Rengar','Riven','Rumble','Ryze','Samira','Senna','Seraphine','Sett','Shen','Shyvana','Singed','Sion','Sivir','Skarner','Smolder','Sona','Soraka','Swain','Syndra','Taliyah','Talon','Teemo','Thresh','Tristana','Tryndamere','Twisted Fate','Twitch','Urgot','Varus','Vayne','Veigar','Vel\'Koz','Vex','Vi','Viego','Viktor','Vladimir','Volibear','Warwick','Wukong','Xayah','Xin Zhao','Yasuo','Yone','Yunara','Yuumi','Zed','Zeri','Ziggs','Zilean','Zoe','Zyra'
];

export const RECOVERED_COMPOSITIONS = [
  {
    id: 'engage-layers',
    name: 'Aperta o R e vai junto',
    archetype: 'Engage em camadas',
    origin: 'RECOVERED_TRAINING_PROPOSAL',
    patch: '7.2e editorial baseline',
    lineup: { BARON: 'Malphite', JUNGLE: 'Wukong', MID: 'Orianna', DUO: 'Xayah', SUPPORT: 'Rakan' },
    plan: 'Duas entradas, dano em área e uma dupla que consegue acompanhar o ritmo.',
    winCondition: 'Forçar lutas agrupadas em janelas de objetivo e encadear iniciação com controle em área.'
  },
  {
    id: 'protect-carry',
    name: 'Operação: carry vivo',
    archetype: 'Proteção e escala',
    origin: 'RECOVERED_TRAINING_PROPOSAL',
    patch: '7.2e editorial baseline',
    lineup: { BARON: 'Ornn', JUNGLE: 'Xin Zhao', MID: 'Orianna', DUO: 'Jinx', SUPPORT: 'Lulu' },
    plan: 'Frontline, controle e proteção para a Jinx converter as lutas longas.',
    winCondition: 'Estender lutas, preservar o carry e jogar em torno de frontline + peel.'
  },
  {
    id: 'siege-range',
    name: 'Sem vida, sem dragão',
    archetype: 'Cerco e alcance',
    origin: 'RECOVERED_TRAINING_PROPOSAL',
    patch: '7.2e editorial baseline',
    lineup: { BARON: 'Jayce', JUNGLE: 'Gragas', MID: 'Ziggs', DUO: 'Ezreal', SUPPORT: 'Karma' },
    plan: 'Alcance e cerco. A vitória começa antes de alguém entrar no fosso.',
    winCondition: 'Criar vantagem de vida e espaço antes do objetivo e evitar entrada frontal sem setup.'
  },
  {
    id: 'side-catch',
    name: 'Sumiu? Já rotacionou.',
    archetype: 'Lateral e captura',
    origin: 'RECOVERED_TRAINING_PROPOSAL',
    patch: '7.2e editorial baseline',
    lineup: { BARON: 'Camille', JUNGLE: 'Lee Sin', MID: 'Galio', DUO: 'Ezreal', SUPPORT: 'Nautilus' },
    plan: 'Captura coordenada com pressão lateral e um ADC autossuficiente.',
    winCondition: 'Abrir mapa pela lateral, criar superioridade numérica e converter pick em objetivo.'
  },
  {
    id: 'snowball-address',
    name: 'Bola de neve com endereço',
    archetype: 'Engage em camadas',
    origin: 'RECOVERED_TRAINING_PROPOSAL',
    patch: '7.2e editorial baseline',
    lineup: { BARON: 'Renekton', JUNGLE: 'Jarvan IV', MID: 'Galio', DUO: 'Lucian', SUPPORT: 'Nami' },
    plan: 'Pressão em duas lanes e uma rota de jungle orientada ao primeiro recurso.',
    winCondition: 'Acelerar cedo, conectar prioridade de rota à jungle e negar estabilização adversária.'
  },
  {
    id: 'anti-engage',
    name: 'Vem que tem resposta',
    archetype: 'Proteção e escala',
    origin: 'RECOVERED_TRAINING_PROPOSAL',
    patch: '7.2e editorial baseline',
    lineup: { BARON: 'Gwen', JUNGLE: 'Poppy', MID: 'Orianna', DUO: 'Xayah', SUPPORT: 'Janna' },
    plan: 'Anti-engage e dano contra frontline, com ameaça de Gwen na lateral.',
    winCondition: 'Negar a primeira entrada, preservar cooldowns defensivos e ganhar espaço depois do engage inimigo.'
  }
];
...
export const DRAFT_ORDER = [
  ...
  ['blue','pick'],['red','pick'],['blue','pick'],['blue','pick'],['red','pick'],['red','pick'],
